...
// import HappyMusic from './undraw_happy_music_g6wc';
      ...
      <div className="bg-gray-100 max-w-screen-sm flex-col space-y-12 mx-auto">
        <div className="space-y-6 flex-col">
          <div className="py-6 bg-gray-400 justify-between px-8 items-center">
            ...
            <div className="flex-col bg-gray-50 rounded-lg items-center px-7 py-1.5 font-semibold text-sm">
              <div>Sign up</div>
              <div className="h-0.5 bg-gray-300 self-stretch" />
              <div>Log in</div>
            </div>
          </div>
        ...
        <div>
          <div className="flex-col space-y-6">
            ...
            <div className="px-8 flex-col space-y-2">
              ...
              <p>
                Train with simultaneous notes, choose your own tonal centers,
                and create custom levels.
              </p>
            </div>
          </div>
        </div>
