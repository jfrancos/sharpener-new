    ...
    <div className="bg-gray-100 max-w-screen-sm flex-col space-y-12 mx-auto">
      <div className="space-y-6 flex-col">
        <div className="py-6 bg-gray-400 justify-between px-8 items-center">
          ...
          <div className="grid">
            <div className="group p-3 -m-3 grid-overlay" onClick={handleLogin}>
              <div
                className={clsx(
                  ' group-hover:bg-gray-700 group-hover:text-gray-300 uppercase flex-col bg-gray-50 rounded-lg items-center px-7 py-1.5 font-semibold text-xs tracking-tight .grid-overlay',
                  user?.loading && 'opacity-40',
                )}
              >
                <p>Log in</p>
            ...
            {user?.loading && (
              <CgSpinner className="text-gray-900 w-8 h-8 flex self-center mx-auto grid-overlay animate-spin" />
            )}
          </div>
        </div>
        ...
        <div className="px-8 text-3xl font-bold inline">
          <p className="tracking-tight leading-10">
            ...
            <span className="text-gray-400 "> with gamified ear training</span>
          </p>
        </div>
        ...
        <div>
          <p className="mx-16 text-xs -my-4 pointer-events-none">
            ...
            to access 50+ curated levels that gradually take you from “Beginner”
            to “Intermediate” (for free!)
          </p>
        </div>
      ...
      <div className="flex-col space-y-6">
        ...
        <div className="px-8 flex-col items-start space-y-2">
          ...
          <p className="">
            Get a thorough ear training foundation for free. 50+ exercises take
            you in baby steps from complete beginner to identifying all twelve
            notes of the scale.
          </p>
        </div>
